...
void swap(timeStruct&, timeStruct&);
int main() {
	...
	do {
		...
		cout << "\t7. Поменять значения времен, с А1 на А2." << endl;
		cout << "\n\tВыбирите действие: "; cin >> A_01; cout << endl;
		switch (A_01) {
		case 1: {
		...
		case 7: {
			cout << "\n\t\tПроизведена операция замены!" << endl;
			swap(time_1, time_2);
			cout << "\n\t\t\tЗначение А1: " << time_1.hours << ":" << time_1.minutes << ":" << time_1.second;
			cout << "\n\t\t\tЗначение А2: " << time_2.hours << ":" << time_2.minutes << ":" << time_2.second;
			cout << endl;
			break;
		}
		default: {
	...
	cout << endl;
	cout << "\tСпасибо! Программа завершена!\n\n";
	system("pause");
	return 0;
}
...
void swap(timeStruct& n1, timeStruct& n2) {
	timeStruct res;
	res = n1;
	n1 = n2;
	n2 = res;
